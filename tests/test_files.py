...
class FilesTestCase(unittest.TestCase):
    ...
    def test_build_working_file_path(self):
        with requests_mock.mock() as mock:
            ...
            path = pipeline.files.build_working_file_path(
                {"id": 'task-01'},
    ...
    def test_new_entity_output_file(self):
        with requests_mock.mock() as mock:
            ...
            result = pipeline.files.new_entity_output_file(
                {"id": "asset-01"},
                {"id": "output-type-01"},
                {"id": "task-type-01"},
                {"id": "working-file-01"},
    ...
    def test_new_instance_output_file(self):
        with requests_mock.mock() as mock:
            ...
            result = pipeline.files.new_asset_instance_output_file(
    ...
    def test_next_entity_output_revision(self):
        with requests_mock.mock() as mock:
            ...
            revision = pipeline.files.get_next_entity_output_revision(
                entity,
                output_type,
                task_type
            )
    ...
    def test_next_asset_instance_output_revision(self):
        with requests_mock.mock() as mock:
            ...
            output_type = {"id": "output-type-01"}
            task_type = {"id": "task-type-01"}
            revision = pipeline.files.get_next_asset_instance_output_revision(
                asset_instance,
                output_type,
                task_type
            )
    ...
    def test_last_output_revision(self):
        with requests_mock.mock() as mock:
            ...
            output_type = {"id": "output-type-01"}
            task_type = {"id": "task-type-01"}
            revision = pipeline.files.get_last_entity_output_revision(
                entity,
                output_type,
                task_type
            )
    ...
    def test_get_working_files_for_task(self):
        with requests_mock.mock() as mock:
            ...
            task = {"id": "task-01"}
            working_files = pipeline.files.get_working_files_for_task(task)
            self.assertEquals(
                working_files[0]["id"],
                "working-file-1"
            )
    ...
    def test_get_last_output_files_for_entity(self):
        with requests_mock.mock() as mock:
            ...
            entity = {"id": "entity-01"}
            output_files_dict = pipeline.files.get_last_output_files_for_entity(
                entity)
            self.assertEquals(
    ...
    def test_get_last_output_files_for_asset_instance(self):
        with requests_mock.mock() as mock:
            ...
            output_files_dict = \
                pipeline.files.get_last_output_files_for_asset_instance(entity)
            self.assertEquals(
                output_files_dict["output-type-01"]["main"]["id"],
                "output-file-1"
            )
    ...
    def test_all_output_types_for_entity(self):
        with requests_mock.mock() as mock:
            ...
            asset = {"id": "asset-1"}
            output_type = pipeline.files.all_output_types_for_entity(asset)
            self.assertEquals(output_type[0]["name"], "geometry")
    ...
    def test_all_output_types_for_asset_instance(self):
        with requests_mock.mock() as mock:
            ...
            output_type = pipeline.files.all_output_types_for_asset_instance(
                asset_instance
            )
            self.assertEquals(output_type[0]["name"], "geometry")
    ...
    def test_get_output_file(self):
        with requests_mock.mock() as mock:
            ...
            output_type = pipeline.files.get_output_file("output-file-1")
    ...
    def test_get_output_files_for_entity(self):
        with requests_mock.mock() as mock:
            ...
            output_type = pipeline.files.all_output_files_for_entity(
                {"id": "asset-1"},
                {"id": "output-type-1"},
            )
    ...
    def test_get_output_files_for_asset_instance(self):
        with requests_mock.mock() as mock:
            ...
            output_type = pipeline.files.all_output_files_for_asset_instance(
                {"id": "asset-instance-1"},
                {"id": "output-type-1"},
            )
            self.assertEquals(output_type[0]["name"], "main")
    ...
    def test_build_entity_output_file_path(self):
        with requests_mock.mock() as mock:
            ...
            path = pipeline.files.build_entity_output_file_path(
                asset,
                output_type,
                task_type
            )
    ...
    def test_build_asset_instance_file_path(self):
        with requests_mock.mock() as mock:
            ...
            output_type = {"id": "output-type-1"}
            task_type = {"id": "task-type-1"}
            path = pipeline.files.build_asset_instance_output_file_path(
                asset_instance,
                output_type,
                task_type
            )
    ...
    def test_new_output_type(self):
        with requests_mock.mock() as mock:
            ...
            output_type = pipeline.files.new_output_type("Geometry", "Geo")
